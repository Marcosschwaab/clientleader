class EquipamentsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @equipament.save
        format.html { redirect_to equipament_url(@equipament), notice: "Equipament was successfully created." }
  ...
  def update
    respond_to do |format|
      if @equipament.update(equipament_params)
        format.html { redirect_to equipament_url(@equipament), notice: "Equipament was successfully updated." }
  ...
  private
    ...
    def equipament_params
      params.require(:equipament).permit(:name)
    end
end
